...
function getDefinitionFileStart() {
  return '// tslint:disable\nimport * as Sequelize from \'sequelize\';\n\ndeclare module \'egg\' {\n\ndeclare namespace Model {\n\nexport type ModelType = typeof Sequelize.Model;\n\n';
}

function getTableDefinition(tsTableDefAttr, tableName) {
  var className = _.upperFirst(_.camelCase(tableName))
  var tableDef = '\n// table: ' + tableName + '\n';
  tableDef += "export type " + className + "Attrs = Omit<" + className + "Model, keyof Sequelize.Model | 'dataValues'>\n";
  ...
  tableDef += 'export type ' + className + 'ModelType = typeof ' + className + 'Model;\n';
  return tableDef;
}
