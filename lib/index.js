...
AutoSequelize.prototype.run = function (callback) {
  ...
  function generateText(err) {
    ...
    async.each(_.keys(self.tables), function (table, _callback) {
      ...
      var tsTableAttr = 'export interface ' + className + 'Attrs {';
      ...
      _.each(fields, function (field, i) {
        ...
        // if (self.options.typescript) {
        tsTableAttr += tsHelper.def.getMemberDefinition(spaces, fieldName, tsVal, tsAllowNull);
      ...
      typescriptFiles[0] += tsHelper.def.getTableDefinition(tsTableAttr + tsTableDef, tableName);
      // }
